...
open class BaseViewController: UIViewController, ITransitionView {
    ...
    public let storageService: IStorageService = HBaseKitManager.shared.getService()
    public let alertService: IAlertDelegate = HBaseKitManager.shared.getService()
    public let localeService: LocalizeService = HBaseKitManager.shared.getService()
...
//        acitvityIndicatorHud.setupView(color: textColor, message: message, font: font)
...
//    }
    ...
    open func onBack(_ sender: AnyObject) {
        let navigationSerview: NavigationService = HBaseKitManager.shared.getService()
