 ...
 */
public class PresenterController: UIViewController, IDestroyable {
...
//        overlayView.autoPinEdgesToSuperviewEdges()
        ...
        addChildViewController(contentPage)
...
//            heightConstraint = contentPage.view.autoSetDimension(.height, toSize: 480)
        ...
        contentPage.didMove(toParentViewController: self)
    ...
    public func destroy() {
        ...
        contentPage.removeFromParentViewController()
